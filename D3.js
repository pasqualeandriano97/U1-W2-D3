...
for (let i = 0; i < starWarsCharacters.length; i++) {
  let nameof = starWarsCharacters[i].name;
  charactersNames.push(nameof);
}
...
*/
for (i = 0; i < charactersNames.lenght; i++) {
  for (j = 0; j < femaleCharacters.lenght; j++) {
...
console.log(
  ...
  " ,il sio colore della pella è ",
  starWarsCharacters[random].skin_color,
  " ,il suo colore degli occhi è ",
